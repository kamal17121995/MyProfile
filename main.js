...
scrollToToBtn.addEventListener('click', () => {
  document.body.scrollTop = 0;
  document.documentElement.scrollTop = 0;
});

// Navigation menu items active on scroll page
...
ScrollReveal().reveal(
  '.skill-description, .service-description, .contact-card, .card-swiper, contact-left h2',
  {
    delay: 700,
    origin: 'left',
  }
